...
def forward(image_number):
       ...
       button_forward = Button(root, text="Maju", command=lambda: forward(image_number+1))
       button_back = Button(root, text="Mundur", command=lambda: back(image_number-1))

       if image_number == 3:
              button_forward = Button(root, text="Maju", state=DISABLED)
...
def back(image_number):
       ...
       if image_number == 1:
              button_back = Button(root, text="Mundur", state=DISABLED)
       
       my_label.grid(row=0, column=0, columnspan=3)
       button_back.grid(row=1, column=0)
       button_forward.grid(row=1, column=2)

button_back = Button(root, text="Mundur", command=back, state=DISABLED)
button_exit = Button(root, text="Keluar", command=root.destroy)
button_forward = Button(root, text="Maju", command=lambda: forward(2))
